	...
	return (
		<section className="bg-black py-20 flex items-center justify-center">
			<div className="container">
				<div className="w-full md:h-96 flex flex-col justify-between  py-20 md:pt-30 md:px-20 px-10 bg-primary/50 rounded-[40px]">
					<div className="w-full h-full text-center md:text-right flex flex-col md:flex-row gap-10 md:gap-0">
						<div className="flex flex-col items-center md:items-start">
							...
							<p className="text-lg md:w-[70%] w-full text-white leading-relaxed mt-4">
								تطبيق التواصل الاجتماعي الأول في المنطقة. تواصل مع الأصدقاء،
								أرسل الهدايا، وانضم للغرف التفاعلية.
							</p>
						</div>
					...
					<div className="w-full mt-10 flex flex-col md:flex-row  justify-between gap-4">
						...
						<h2 className="text-white md:w-[41%] w-full text-center md:text-right">
							صُنع بـ🤍 من فــــريـــــق وينــر الــتقني
						</h2>
					</div>
				</div>
			</div>
