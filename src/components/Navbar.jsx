	...
	return (
		<div className="flex justify-between items-center relative">
			...
			<div className="hidden lg:flex items-center gap-6">
				...
				<Link
					to="/login"
					className="flex items-center gap-2 h-12 w-[180px] rounded-[10px] bg-linear-to-b from-yellow-500 to-yellow-700 icon-text-hover p-[2px] text-primary"
				>
					<div className="flex items-center gap-2 w-full h-full justify-center rounded-[8px] bg-[#6B6758]">
			...
			>
				...
				<div className="flex flex-col p-4 space-y-4 max-h-[80vh] overflow-y-auto">
					...
					<div className="flex flex-col gap-4 mt-4">
						...
						<Link
							to="/login"
							className="flex items-center gap-2 h-12 w-full rounded-[10px] bg-linear-to-b from-yellow-500 to-yellow-700 icon-text-hover p-[2px] text-primary"
							onClick={() => setIsMenuOpen(false)}
						>
							<div className="flex items-center gap-2 w-full h-full justify-center rounded-[8px] bg-[#6B6758]">
								<img src="./login.svg" alt="login" />
